...
- [imagegen-mcp-x402](https://github.com/clawdbotworker/imagegen-mcp) - AI image generation MCP server via x402 micropayments on Base — $0.10 USDC per image. Alias for coinopai-imagegen.

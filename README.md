...
- [io.github.forgemeshlabs/x402-scan-mcp](https://github.com/forgemeshlabs/x402-scan-mcp) - x402 Endpoint Scanner — a free local health probe for x402 paid endpoints as an MCP server.
